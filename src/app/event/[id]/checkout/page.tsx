...
import { CustomApplayout, EventBanner } from '@/components';
        ...
        <div className="w-full flex flex-col gap-8">
          <div className="w-full flex flex-col gap-4">
            ...
            <p>
              ...
              networking opportunities with industry leaders. Discover the latest trends in
              artificial intelligence, blockchain, cybersecurity, and more. Whether you&lsquo;re a
              tech veteran or just starting your journey, the Tech Innovators Summit is the ultimate
              destination to explore, learn, and connect in the dynamic tech landscape.
            </p>
          </div>
